...
public class StateMachineTest {
  ...
  public static class Test3 extends System2SubsystemTest implements Multiphase {
    ...
    @Override
    protected void verify() {
      mustBeTransitionedInto(_id_fs1111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fps1112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fs11111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fps11112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fs4111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fps4112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fs111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fps112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fs211, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fps212, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fs2111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fps2112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fs21111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fps21112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fs3111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fps3112, CtxPackage.Literals.SYSTEM_ANALYSIS);

      mustBeTransitionedInto(_id_fs1111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps1112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs11111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps11112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs4111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps4112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs211, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps212, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs2111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps2112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs21111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps21112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs3111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps3112, LaPackage.Literals.LOGICAL_ARCHITECTURE);

      mustBeTransitionedInto(_id_fs1111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps1112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs11111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps11112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs4111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps4112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs211, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps212, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs2111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps2112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs21111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps21112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs3111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps3112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
  ...
  public static class Test4 extends System2SubsystemTest implements Multiphase {
    ...
    protected void verify() {
      ...
      shouldNotBeTransitionedInto(_id_fs111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fps112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fs211, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fps212, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fs1111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      shouldNotBeTransitionedInto(_id_fps1112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fs11111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fps11112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fs4111, CtxPackage.Literals.SYSTEM_ANALYSIS);
      mustBeTransitionedInto(_id_fps4112, CtxPackage.Literals.SYSTEM_ANALYSIS);
      ...
      shouldNotBeTransitionedInto(_id_fs111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs211, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps212, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs1111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps1112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs11111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps11112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs4111, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps4112, LaPackage.Literals.LOGICAL_ARCHITECTURE);
      ...
      shouldNotBeTransitionedInto(_id_fs111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs211, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps212, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fs1111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      shouldNotBeTransitionedInto(_id_fps1112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs11111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps11112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fs4111, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
      mustBeTransitionedInto(_id_fps4112, PaPackage.Literals.PHYSICAL_ARCHITECTURE);
